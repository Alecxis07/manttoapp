...
watch(() => form.customer_id, (value, oldValue) => {
    ...
    <AppLayout :title="`Editar ${quotation.folio}`">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Editar {{ quotation.folio }} v{{ quotation.version }}
            </h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <FormSection @submitted="submit">
                    ...
                    <template #description>
                        Solo cotizaciones en borrador pueden editarse (RN-COT-001).
                    </template>
                            ...
                            >
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                    <div>
                                        ...
                                        <select v-model="item.item_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                    <TextInput v-model="item.quantity" type="number" step="0.01" class="block w-full" />
                                    <TextInput v-model="item.unit_price" type="number" step="0.01" class="block w-full" />
                                    <TextInput v-model="item.discount" type="number" step="0.01" class="block w-full" />
                                    <TextInput v-model="item.description" type="text" class="block w-full" />
                                </div>
                            </div>
                        </div>
